// CGMLScanner.cpp: implementation of the CGMLScanner class.
//
//////////////////////////////////////////////////////////////////////
...
CGMLScanner::GML_token CGMLScanner::scan(FILE* source) 
{
	...
	case '"':
		...
		if (next == '&') {
		  ...
		  if (ISO_count) {
			...
			ISO_count++;
			next = searchISO (ISO_buffer, ISO_count);
			ISO_count = 0;
		  } else {
			next = '&';
		  }
...
int CGMLScanner::searchISO (char* str, int len) {
